...
/// player class
/// </summary>
class GBackground : public CMoveObject
{
public:
#pragma region constructor
	...
	GBackground(SVector2 _pos) : CMoveObject(_pos) {}
	...
	GBackground(SVector2 _pos, SVector2 _size) : CMoveObject(_pos, _size) {}
	...
	GBackground(SVector2 _pos, SVector2 _size, CRenderer* _pRenderer,
